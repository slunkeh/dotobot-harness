...
_CLARIFY_PROMPT = (
    ...
    "General citation guidance does not require changing an approved message or "
    "asking again: keep supporting links in your explanation or review context. "
    "If the user explicitly requests citations in the outgoing message, include "
    "them in the proposal before approval; a later requested edit needs a new proposal. "
